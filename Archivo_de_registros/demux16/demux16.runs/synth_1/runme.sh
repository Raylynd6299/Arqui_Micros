...
HD_PWD='C:/Users/Ray/Desktop/Arquitectura/Archivo_de_registros/demux16/demux16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demux_16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demux_16.tcl
