...
HD_PWD='C:/Users/Ray/Desktop/Arquitectura/Archivo_de_registros/Barrel/Barrel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Barrel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Barrel.tcl
