...
HD_PWD='C:/Users/Ray/Desktop/Arquitectura/Archivo_de_registros/arcchivo_de_registro/arcchivo_de_registro.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Arc_Reg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Arc_Reg.tcl
