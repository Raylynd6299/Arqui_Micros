...
HD_PWD='C:/Users/Ray/Desktop/Arquitectura/sum_anticipado/sum_anticipado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sum_acarreo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sum_acarreo.tcl -notrace
