...
HD_PWD='C:/Users/Ray/Desktop/Arquitectura/sum_anticipado/sum_anticipado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sum_acarreo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sum_acarreo.tcl
