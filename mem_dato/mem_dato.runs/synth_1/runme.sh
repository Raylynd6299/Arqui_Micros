...
HD_PWD='C:/Users/Ray/Desktop/Arquitectura/mem_dato/mem_dato.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memo_dato.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memo_dato.tcl
