...
HD_PWD='C:/Users/Ray/Desktop/Arquitectura/Unid_control/UC_F/UC_F.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UC_F.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UC_F.tcl
