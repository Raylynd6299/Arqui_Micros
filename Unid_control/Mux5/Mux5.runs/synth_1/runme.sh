...
HD_PWD='C:/Users/Ray/Desktop/Arquitectura/Unid_control/Mux5/Mux5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mux5.tcl
