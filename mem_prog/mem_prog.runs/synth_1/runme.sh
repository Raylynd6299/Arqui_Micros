...
HD_PWD='C:/Users/Ray/Desktop/Arquitectura/mem_prog/mem_prog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_program.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_program.tcl
