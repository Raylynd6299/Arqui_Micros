...
c(0) <= aluop(2);
    ...
    z <= not(aux(15) or aux(14) or aux(13) or aux(12) or aux(11) or aux(10) or aux(9) or aux(8) or aux(7) or aux(6) or aux(5) or aux(4) or aux(3) or aux(2) or aux(1) or aux(0)); --zero    falta por parametrizar
