...
HD_PWD='C:/Users/Ray/Desktop/Arquitectura/ESCOMips/ESCOMMips/ESCOMMips.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ESCOMMips.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ESCOMMips.tcl
