...
HD_PWD='C:/Users/Ray/Desktop/Arquitectura/alun/alun.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log aluN.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source aluN.tcl -notrace
